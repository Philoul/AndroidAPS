...
enum class BooleanKey(
    ...
    NfcEnableBackgroundDetection("nfccommunicator_background_detection", false, R.string.pref_title_nfc_enable_background_detection, R.string.pref_summary_nfc_enable_background_detection),
