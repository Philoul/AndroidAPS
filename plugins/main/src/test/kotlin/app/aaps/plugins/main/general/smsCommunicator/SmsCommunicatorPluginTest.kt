...
class SmsCommunicatorPluginTest : TestBaseWithProfile() {
    ...
    @BeforeEach fun prepareTests() {
        ...
        whenever(ch.toPump(anyDouble())).thenAnswer { invocation -> invocation.getArgument<Double>(0) }
        whenever(ch.fromPump(anyDouble())).thenAnswer { invocation -> invocation.getArgument<Double>(0) }
    }
